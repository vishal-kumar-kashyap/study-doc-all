package hdfc.whatsnew.module.scheduler;
...
import hdfc.whatsnew.module.constants.HdfcWhatsNewPortletKeys;
import hdfc.whatsnew.module.helper.WhatsNewHelper;
import hdfc.whatsnew.module.portlet.HdfcWhatsNewPortlet;

@Component(immediate = true, property = { "cron.expression=0 0 0 * * ?" },service = WhatsNewArticleSyncListener.class)
public class WhatsNewArticleSyncListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		_log.info("What's new  sync scheduler starts at:"+new Date());
		
		WhatsNewHelper.addNewArticles();
		_log.info("What's new scheduler ends at:"+new Date());
	}
	...
	protected void activate(Map<String, Object> properties) throws SchedulerException {
		...
		String cronExpression = GetterUtil.getString(HdfcWhatsNewPortletKeys.WHATSNEWARTICLE_SYNC_SCHEDULER_CRON_EXPRESSION, _DEFAULT_CRON_EXPRESSION);
	...
	private static final Log _log = LogFactoryUtil.getLog(WhatsNewArticleSyncListener.class);
